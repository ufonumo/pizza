            ...
            <div className={styles.ingredients}>
                ...
                <div className={styles.option}>
                    <input 
                        type="checkbox" 
                        id="spicy" 
                        name="spicy" className={styles.checkbox}
                    />
                    <label htmlFor="spicy">Extra spicy Ingredient</label>
                </div>
                <div className={styles.option}>
                    <input 
                        type="checkbox" 
                        id="cheese" 
                        name="cheese" className={styles.checkbox}
                    />
                ...
                <div className={styles.option}>
                    <input 
                        type="checkbox" 
                        id="garlic" 
                        name="garlic" className={styles.checkbox}
                    />
